  ...
  Widget _buildBody() {
    ...
    return Stack(
      children: [
        ...
        // Dark overlay layout (top + bottom) with transparent center
        if (!_isFlashOn)
          Positioned.fill(
            child: Column(
              ...
              children: [
                ...
                // Center: face frame + instruction (transparent area)
                Column(
                  children: [
                    AnimatedBuilder(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: _isRegistering ? null : _takeAndRegisterFace,
        ...
        // When flash is ON, show top bar and bottom panel separately
        if (_isFlashOn) ...[
          Positioned(
            top: 0,
            left: 0,
